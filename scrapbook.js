...
const allScrapbooks = {
    ...
    "texas":[
            ...
            { src: 'images/texas7.png', caption: '' },
            { src: 'images/texas8.png', caption: '' },
            { src: 'images/texas9.png', caption: '' },
            { src: 'images/texas10.png', caption: '' },
            { src: 'images/texas11.png', caption: '' },
            { src: 'images/texas12.png', caption: '' },
        ],
    "bahamas":[
            { src: 'images/bahamas1.png', caption: '' },
            { src: 'images/bahamas2.png', caption: '' },
            { src: 'images/bahamas3.png', caption: '' },
            { src: 'images/bahamas4.png', caption: '' },
            { src: 'images/bahamas5.png', caption: '' },
            { src: 'images/bahamas6.png', caption: '' },
            { src: 'images/bahamas7.png', caption: '' },
            { src: 'images/bahamas8.png', caption: '' },
            { src: 'images/bahamas9.png', caption: '' },
            { src: 'images/bahamas10.png', caption: '' },
            { src: 'images/bahamas11.png', caption: '' },
            { src: 'images/bahamas12.png', caption: '' },
            { src: 'images/bahamas13.png', caption: '' },
            { src: 'images/bahamas14.png', caption: '' },
            { src: 'images/bahamas15.png', caption: '' },
            { src: 'images/bahamas16.png', caption: '' },
            { src: 'images/bahamas17.png', caption: '' },
